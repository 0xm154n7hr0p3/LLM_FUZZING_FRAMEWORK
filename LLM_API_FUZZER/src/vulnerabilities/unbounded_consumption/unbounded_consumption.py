...
class UnboundedConsumptionFuzzer:
    ...
    def __init__(
        ...
        self.max_token_threshold = max_token_threshold if max_token_threshold is not None else 5000
        self.rate_limit_test_count = rate_limit_test_count if rate_limit_test_count is not None else 15
        self.rate_limit_interval = rate_limit_interval if rate_limit_interval is not None else 0.01
